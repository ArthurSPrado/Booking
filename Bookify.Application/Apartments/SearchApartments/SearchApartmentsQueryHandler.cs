...
internal sealed class
    SearchApartmentsQueryHandler : IQueryHandler<SearchApartmentsQuery, IReadOnlyList<ApartmentsResponse>>
{
    ...
    public async Task<Result<IReadOnlyList<ApartmentsResponse>>> Handle(SearchApartmentsQuery request,
